...
***********************************************************************************************************************/
/* Note lengths */
#define MEASURE_TIME              (u16)2000  /* Time in ms for 1 measure (1 full note) - should be divisible by 8*/
...
#define REGULAR_NOTE_TIME         (u16)((QUARTER_NOTE / 3) + 1)
#define STACCATO_NOTE_TIME        (u16)((QUARTER_NOTE * 2 / 3) + 1)
